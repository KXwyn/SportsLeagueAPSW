...
namespace SportsLeague.Domain.Services
{
    public class MatchService : IMatchService
    {
        ...
        public async Task<Match> CreateAsync(Match match)
        {
            ...
            /*
            //Validar que tenga un numero minimo de Jugadores inscritos en el torneo especifico para cada equipo
            var homePlayersCount = await _tournamentTeamRepository
                .GetPlayersCountAsync(match.TournamentId, match.HomeTeamId);
            if (homePlayersCount < tournament.MinPlayersPerTeam)
                throw new InvalidOperationException(
                    $"El equipo local debe tener al menos {tournament.MinPlayersPerTeam} jugadores inscritos en el torneo");
            */
