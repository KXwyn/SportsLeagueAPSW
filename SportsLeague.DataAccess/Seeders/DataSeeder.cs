...
namespace SportsLeague.DataAccess.Seeders
{
    public static class DataSeeder
    {
            ...
            var teams = new List<Team>
        {
            ...
            new() { Name="Deportivo Pasto", City="Pasto", Stadium="Departamental Libertad", FoundedDate = new DateTime(1949, 1, 12) },
            ...
            new() { Name="Internacional de Bogotá", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate = new DateTime(2005, 1, 1) },
        };
